...
export default function Signin({ isOpen }: SigninProps) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="text-xs leading-8 font-bold uppercase w-full py-4 cursor-pointer bg-[#8d3dc8] text-white rounded mt-2 transition duration-150 ease-linear hover:bg-[#81259d] focus:outline-none"
      >
        Continuar
      </button>

      <Link href={"#signup"} className="text-[#81259d] mt-4">
